...
define('STUDENT_STATUS_DANG_HOC', 0);//Đang học

define('TEACHER_STATUS_TEACHING', 1);// Đang giảng dạy
define('TEACHER_STATUS_CEASE', 2); // Nghỉ dạy
...
define('USER_GENDER_UNDEFINED', 0);
